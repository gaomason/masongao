const researchLogEntries = [
  {
    ...
    body: [
      ...
      "1. Still working on improving QSopt_ex: Working on different approaches to MCLU updates. Have some good ideas, but the devil is in the implementation."
      "2. Working on a new problem that is quite interesting: For a wide body of optimization problems, if you are only able to 'merge' potential solutions, can you still solve the problem in polynomial merges?"
    ]
  }
];
